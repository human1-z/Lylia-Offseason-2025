...
Utility:    This sample type is provided as a useful tool, or aide, to perform some specific development task.
            It is not expected to be something you would include in your own lyliaRobot code.
...
Special programming methods, or lyliaRobot control techniques should be reserved for “Concept” Samples,
